...
exports.register = function(server, options, next) {
  ...
  server.app.db = MongoJS("clinton:adradmin@ds147510.mlab.com:47510/adrdb", [
    "users",
    "reports",
    "auths"
  ]);
  ...
  const routes = [
    ...
    },
    {
      ...
      handler: handlers.getReportDetails,
      config: {
        auth: "session",
        plugins: {
          hapiAuthorization: {
